...
class ArtWorkSerializer(serializers.ModelSerializer):
    ...
    image = ArtWorkImageSerializer(write_only=True, required=False, many=True)
    ...
    def create(self, validated_data):
        ...
        featured_image = dict((self.request.FILES).lists()).get('featured_image').pop()
        images = modify_image_input(images, False)
        images.append(dict([('image', featured_image), ('is_featured', True)]))
